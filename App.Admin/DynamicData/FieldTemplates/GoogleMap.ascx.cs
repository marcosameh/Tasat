...
{
    public partial class GoogleMapField : System.Web.DynamicData.FieldTemplateUserControl
    {
        ...
        public string GetCoordinates(string value)
        {
            if (string.IsNullOrWhiteSpace(value))
            {
                return string.Empty;
            }
            var pointData = value.Split(new char[] { ';' }, StringSplitOptions.RemoveEmptyEntries);
