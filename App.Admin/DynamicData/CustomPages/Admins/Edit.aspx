<%@ Page Language="C#" MasterPageFile="~/Site.master" CodeBehind="Edit.aspx.cs" Inherits="DynamicData.Admin.CustomPages.Admins.Edit" %>
        ...
        <asp:FormView runat="server" ID="FormView1" DataSourceID="DetailsDataSource" DefaultMode="Edit" 
            ...
            <EditItemTemplate>
                <table id="detailsTable" class="table table-primary mb30">
                    ...
                    <tr class="row">
                        <td colspan="3" class="col-md-12">
                            <asp:LinkButton runat="server" CommandName="Update" CssClass="btn btn-success" Text="Update" CommandArgument='<%#Eval("AspNetUserId") %>' />
