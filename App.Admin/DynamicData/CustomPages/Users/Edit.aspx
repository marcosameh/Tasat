<%@ Page Language="C#" MasterPageFile="~/Site.master" CodeBehind="Edit.aspx.cs" Inherits="DynamicData.Admin.Users.Edit" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="main" runat="Server">
    ...
    <div class="contentpanel">
        ...
        <asp:FormView runat="server" ID="FormView1" DataSourceID="DetailsDataSource" DefaultMode="Edit"
            OnItemCommand="FormView1_ItemCommand" OnItemUpdated="FormView1_ItemUpdated" RenderOuterTable="false" OnItemUpdating="FormView1_ItemUpdating">
            <EditItemTemplate>
                <table id="detailsTable" class="table table-primary mb30">
                    <asp:DynamicEntity runat="server" Mode="Edit" />
                    <tr class="row">
                        <td colspan="3" class="col-md-12">
                            <uc1:MembershipUser runat="server" ID="MembershipUser" AspNetId='<%#Eval("AspNetUserId") %>'/>
                        </td>
                    </tr>
                    ...
                    <tr class="row">
                        <td colspan="2" class="text-right">
                            ...
                            <asp:LinkButton runat="server" CommandName="Update" ValidationGroup="vgInsert" CssClass="btn btn-success" Text="Update"  CommandArgument='<%#Eval("AspNetUserId") %>' />
                        </td>
                    </tr>
                </table>
            </EditItemTemplate>
