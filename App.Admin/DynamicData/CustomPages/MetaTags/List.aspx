<%@ Page Language="C#" MasterPageFile="~/Site.master" CodeBehind="List.aspx.cs"
    Inherits="DynamicData.Admin.DynamicData.CustomPages.MetaTags.List" %>
    ...
    <div class="pageheader">
        <div class="media">
            ...
            <div class="media-body">
                ...
                <asp:DynamicHyperLink Visible="false" CssClass="btn btn-sm btn-info pull-right" ID="InsertHyperLink" runat="server" Action="Insert">
            ...
            <div class="col-md-12">
                <div class="table-responsive">
                    <asp:GridView ID="GridView1" runat="server" DataSourceID="GridDataSource"
                         data-page-length='50' AutoGenerateColumns="false"
                        EnablePersistedSelection="true" AllowPaging="false" AllowSorting="false"
                        CssClass="table table-primary mb30 responsive dataTable no-footer fixed-image" 
                        ...
                        <Columns>
                            <asp:TemplateField HeaderStyle-CssClass="table-actions" ItemStyle-CssClass="table-action">
                                <ItemTemplate>
                                    ...
                                    &nbsp;
                                    <asp:LinkButton Visible="false" runat="server" CommandName="Delete"
                                    ...
                                    <asp:DynamicHyperLink Visible="false" runat="server">
                                        <i class="fa fa-bars tooltips" data-toggle="tooltip"
                                        title="Details"></i>
                                    </asp:DynamicHyperLink>
                                </ItemTemplate>
                            </asp:TemplateField>
                                 <asp:DynamicField DataField="SitePage" HeaderText="Page" />

                            <asp:BoundField DataField="Title" HeaderText="Meta Title" />
                        </Columns>
