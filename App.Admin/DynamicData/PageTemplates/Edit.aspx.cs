...
namespace DynamicData.Admin
{
    public partial class Edit : System.Web.UI.Page
    {
        ...
        protected void DetailsDataSource_Updated(object sender, Microsoft.AspNet.EntityDataSource.EntityDataSourceChangedEventArgs e)
        {
            if (e.Exception == null)
            {
                int itemId = (int)e.Entity.GetType().GetProperty("Id").GetValue(e.Entity, null);
                LocalizedItems ucLocalizedItems = (FormView1.FindControl("LocalizedItems") as LocalizedItems);
