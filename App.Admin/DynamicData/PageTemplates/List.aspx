<%@ Page Language="C#" MasterPageFile="~/Site.master" CodeBehind="List.aspx.cs" Inherits="DynamicData.Admin.List" %>
            ...
            <div class="col-md-12">
                <div class="table-responsive">
                    <asp:GridView ID="GridView1" runat="server" DataSourceID="GridDataSource" data-page-length='50'
                        EnablePersistedSelection="true" AllowPaging="false" AllowSorting="false" OnRowDataBound="GridView1_RowDataBound"
                        ...
                        <Columns>
                            <asp:TemplateField HeaderStyle-CssClass="table-actions" ItemStyle-CssClass="table-action">
                                <ItemTemplate>
                                    <asp:DynamicHyperLink ID="btnEdit" runat="server" Action="Edit">
